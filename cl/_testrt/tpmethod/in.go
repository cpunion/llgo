...
// CHECK-NEXT:   %3 = call ptr @"{{.*}}/runtime/internal/runtime.NewItab"(ptr @"_llgo_iface$DoRJPuBst8Lp1uEP2e7OnwiP-bLraZwFmeGcjrik3Mw", ptr @"*_llgo_main.future[main.Tuple[error]]")
...
// CHECK-NEXT:   call void %__llgo_funcval_code(ptr {{(nest|swiftself)}} %7, { ptr, ptr } %1)
// CHECK-NEXT:   ret void
// CHECK-NEXT: }
