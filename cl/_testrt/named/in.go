...
// CHECK-NEXT:   %__llgo_funcval_code = call ptr asm "", "=r,0"(ptr %135)
// CHECK-NEXT:   %136 = call i64 %__llgo_funcval_code(ptr {{(nest|swiftself)}} %134, i64 -2)
...
// CHECK-NEXT:   %__llgo_funcval_code1 = call ptr asm "", "=r,0"(ptr %160)
// CHECK-NEXT:   %161 = call i64 %__llgo_funcval_code1(ptr {{(nest|swiftself)}} %159, i64 -3)
