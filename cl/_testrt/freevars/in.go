...
// CHECK-NEXT:   call void %__llgo_funcval_code(ptr {{(nest|swiftself)}} %19, %"{{.*}}/runtime/internal/runtime.iface" %1)
// CHECK-NEXT:   ret void
// CHECK-EMPTY:
...
// CHECK-NEXT:   %__llgo_funcval_code1 = call ptr asm "", "=r,0"(ptr %25)
// CHECK-NEXT:   call void %__llgo_funcval_code1(ptr {{(nest|swiftself)}} %24, %"{{.*}}/runtime/internal/runtime.iface" zeroinitializer)
// CHECK-NEXT:   ret void
// CHECK-NEXT: }
