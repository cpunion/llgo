...
// CHECK-NEXT:   %2 = load ptr, ptr @main._cgo_e0cb7ec06f76_Cfunc_cos, align 8
...
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   %1 = call ptr @"{{.*}}/runtime/internal/runtime.AllocZ"(i64 8)
// CHECK-NEXT:   %2 = load ptr, ptr @main._cgo_e0cb7ec06f76_Cfunc_free, align 8
// CHECK-NEXT:   %3 = load ptr, ptr %2, align 8
...
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   %1 = call ptr @"{{.*}}/runtime/internal/runtime.AllocZ"(i64 8)
// CHECK-NEXT:   %2 = load ptr, ptr @main._cgo_e0cb7ec06f76_Cfunc_log, align 8
// CHECK-NEXT:   %3 = load ptr, ptr %2, align 8
// CHECK-NEXT:   %4 = call double %3(double %0)
// CHECK-NEXT:   ret double %4
// CHECK-NEXT: }
...
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   %1 = call ptr @"{{.*}}/runtime/internal/runtime.AllocZ"(i64 8)
// CHECK-NEXT:   %2 = load ptr, ptr @main._cgo_e0cb7ec06f76_Cfunc_puts, align 8
// CHECK-NEXT:   %3 = load ptr, ptr %2, align 8
...
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   %1 = call ptr @"{{.*}}/runtime/internal/runtime.AllocZ"(i64 8)
// CHECK-NEXT:   %2 = load ptr, ptr @main._cgo_e0cb7ec06f76_Cfunc_sin, align 8
// CHECK-NEXT:   %3 = load ptr, ptr %2, align 8
// CHECK-NEXT:   %4 = call double %3(double %0)
// CHECK-NEXT:   ret double %4
// CHECK-NEXT: }
...
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   %1 = call ptr @"{{.*}}/runtime/internal/runtime.AllocZ"(i64 8)
// CHECK-NEXT:   %2 = load ptr, ptr @main._cgo_e0cb7ec06f76_Cfunc_sqrt, align 8
// CHECK-NEXT:   %3 = load ptr, ptr %2, align 8
// CHECK-NEXT:   %4 = call double %3(double %0)
// CHECK-NEXT:   ret double %4
// CHECK-NEXT: }
...
// CHECK-NEXT:   store ptr @_cgo_e0cb7ec06f76_Cfunc_cos, ptr @main._cgo_e0cb7ec06f76_Cfunc_cos, align 8
// CHECK-NEXT:   store ptr @_cgo_e0cb7ec06f76_Cfunc_free, ptr @main._cgo_e0cb7ec06f76_Cfunc_free, align 8
// CHECK-NEXT:   store ptr @_cgo_e0cb7ec06f76_Cfunc_log, ptr @main._cgo_e0cb7ec06f76_Cfunc_log, align 8
// CHECK-NEXT:   store ptr @_cgo_e0cb7ec06f76_Cfunc_puts, ptr @main._cgo_e0cb7ec06f76_Cfunc_puts, align 8
// CHECK-NEXT:   store ptr @_cgo_e0cb7ec06f76_Cfunc_sin, ptr @main._cgo_e0cb7ec06f76_Cfunc_sin, align 8
// CHECK-NEXT:   store ptr @_cgo_e0cb7ec06f76_Cfunc_sqrt, ptr @main._cgo_e0cb7ec06f76_Cfunc_sqrt, align 8
// CHECK-NEXT:   store ptr @_cgo_e0cb7ec06f76_Cfunc__Cmalloc, ptr @main._cgo_e0cb7ec06f76_Cfunc__Cmalloc, align 8
...
// CHECK-NEXT:   %3 = call i32 @main._Cfunc_puts(ptr %2)
...
// CHECK-NEXT:   %__llgo_funcval_code = call ptr asm "", "=r,0"(ptr %18)
// CHECK-NEXT:   %19 = call ptr %__llgo_funcval_code(ptr {{(nest|swiftself)}} %17)
...
// CHECK-NEXT:   %26 = insertvalue { ptr, ptr } { ptr @"main.main$2", ptr undef }, ptr %24, 1
// CHECK-NEXT:   %27 = extractvalue { ptr, ptr } %26, 1
// CHECK-NEXT:   %28 = extractvalue { ptr, ptr } %26, 0
// CHECK-NEXT:   %__llgo_funcval_code1 = call ptr asm "", "=r,0"(ptr %28)
// CHECK-NEXT:   %29 = call %"{{.*}}/runtime/internal/runtime.Slice" %__llgo_funcval_code1(ptr {{(nest|swiftself)}} %27)
...
// CHECK-NEXT:   call void @"{{.*}}/runtime/internal/runtime.PrintByte"(i8 10)
// CHECK-NEXT:   %30 = call double @main._Cfunc_sqrt(double 2.000000e+00)
...
// CHECK-NEXT:   %42 = call double @main._Cfunc_sin(double 2.000000e+00)
...
// CHECK-NEXT:   %54 = call double @main._Cfunc_cos(double 2.000000e+00)
...
// CHECK-NEXT:   %66 = call double @main._Cfunc_log(double 2.000000e+00)
...
// CHECK-NEXT:   %80 = insertvalue { ptr, ptr } { ptr @"main.main$3", ptr undef }, ptr %78, 1
// CHECK-NEXT:   %81 = extractvalue { ptr, ptr } %80, 1
// CHECK-NEXT:   %82 = extractvalue { ptr, ptr } %80, 0
// CHECK-NEXT:   %__llgo_funcval_code2 = call ptr asm "", "=r,0"(ptr %82)
// CHECK-NEXT:   call void %__llgo_funcval_code2(ptr {{(nest|swiftself)}} %81)
...
// CHECK-NEXT:   %85 = insertvalue { ptr, ptr } { ptr @"main.main$4", ptr undef }, ptr %83, 1
// CHECK-NEXT:   %86 = extractvalue { ptr, ptr } %85, 1
// CHECK-NEXT:   %87 = extractvalue { ptr, ptr } %85, 0
// CHECK-NEXT:   %__llgo_funcval_code3 = call ptr asm "", "=r,0"(ptr %87)
// CHECK-NEXT:   call void %__llgo_funcval_code3(ptr {{(nest|swiftself)}} %86)
// CHECK-NEXT:   ret void
// CHECK-NEXT: }
