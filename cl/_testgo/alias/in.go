...
// CHECK-NEXT:   %1 = getelementptr inbounds %main.Point, ptr %0, i32 0, i32 0
// CHECK-NEXT:   %2 = getelementptr inbounds %main.Point, ptr %0, i32 0, i32 1
// CHECK-NEXT:   store double 1.000000e+00, ptr %1, align 8
// CHECK-NEXT:   store double 2.000000e+00, ptr %2, align 8
// CHECK-NEXT:   call void @"main.(*Point).Scale"(ptr %0, double 2.000000e+00)
// CHECK-NEXT:   call void @"main.(*Point).Move"(ptr %0, double 3.000000e+00, double 4.000000e+00)
// CHECK-NEXT:   %3 = getelementptr inbounds %main.Point, ptr %0, i32 0, i32 0
// CHECK-NEXT:   %4 = load double, ptr %3, align 8
// CHECK-NEXT:   %5 = getelementptr inbounds %main.Point, ptr %0, i32 0, i32 1
