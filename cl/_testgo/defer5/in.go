...
func main() {
	...
	// WINDOWS-AMD64: [[SETJMP_FRAME:%[0-9]+]] = call ptr @llvm.frameaddress.p0(i32 0)
	// WINDOWS-AMD64-NEXT: [[SETJMP_RESULT:%[0-9]+]] = call i32 @_setjmpex(ptr [[DEFER_JMPBUF]], ptr [[SETJMP_FRAME]])
