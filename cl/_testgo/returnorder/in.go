...
// CHECK-NEXT: _llgo_0:
// CHECK-NEXT:   %0 = alloca %main.state, align 8
// CHECK-NEXT:   call void @llvm.memset.p0.i64(ptr %0, i8 0, i64 8, i1 false)
// CHECK-NEXT:   %1 = call { %main.state, i64 } @main.returnStateAndMut()
// CHECK-NEXT:   %2 = extractvalue { %main.state, i64 } %1, 0
// CHECK-NEXT:   store %main.state %2, ptr %0, align 8
// CHECK-NEXT:   %3 = extractvalue { %main.state, i64 } %1, 1
// CHECK-NEXT:   %4 = getelementptr inbounds %main.state, ptr %0, i32 0, i32 0
...
// CHECK-NEXT:   %7 = getelementptr inbounds %main.state, ptr %0, i32 0, i32 0
