...
// This fixture now checks the stable stackless architecture rather than every
...
// CHECK-LABEL: define linkonce ptr @__llgo_coro_func_coro_v2.method-value.{{.*}}(ptr %0, ptr %1, ptr %2, ptr %3, i64 %4){{.*}} {
