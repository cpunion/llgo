...
// CHECK-LABEL: define ptr @"{{.*}}/cl/_testgo/reflectfn.demo$coro"(ptr %0, ptr %1){{.*}} {
...
// CHECK-LABEL: define ptr @"{{.*}}/cl/_testgo/reflectfn.main$coro"(ptr %0, ptr %1){{.*}} {
...
// CHECK-LABEL: define ptr @"{{.*}}/cl/_testgo/reflectfn.main$1$coro"(ptr %0, ptr %1, ptr swiftself %2){{.*}} {
