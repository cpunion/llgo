...
// panic replacement, and implicit-fault replacement. Keep it in its own
// production source so named runtime test islands cannot accidentally acquire
// it merely by compiling the frame allocator.
