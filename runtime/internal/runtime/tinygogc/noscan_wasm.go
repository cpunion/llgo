...
// live without recursively tracing its payload. Fiber and Asyncify buffers are
// scanned through the active physical stack and compiler root chains instead;
// scanning their complete unused capacity turns stale stack words into roots.
