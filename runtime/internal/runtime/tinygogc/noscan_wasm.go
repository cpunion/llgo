...
// live without recursively tracing its payload. The main Fiber and system
// Asyncify buffers are scanned through the active physical stack and compiler
// root chains instead; scanning their multi-megabyte unused capacity turns
// stale stack words into roots. Suspended ordinary goroutine stacks remain
// conservatively scanned as a fallback for values live across cooperative
// scheduling.
