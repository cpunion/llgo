...
// object, owns when the next bounded slice may run.
func coroTargetAcquireManagedExecutionV1(*coro.ExecutorDriver) (bool, bool) {
	return true, true
}

func coroTargetReleaseManagedExecutionV1(*coro.ExecutorDriver) bool {
	return true
}

func coroTargetWaitManagedExecutionV1(*coro.ExecutorDriver) bool {
	return false
}
