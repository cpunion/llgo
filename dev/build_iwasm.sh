...
# Determine platform. WAMR's Windows platform sources expect MSVC preprocessing;
# this compiler choice is only for the host-side iwasm test helper.
IWASM_NAME="iwasm"
...
# Tests execute Wasm bytecode only; reference types are required by LLGo output.
