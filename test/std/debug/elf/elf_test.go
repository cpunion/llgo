...
const wasmELFFixture = ``
...
func buildLinuxFixture(t *testing.T) string {
	...
	if runtime.GOARCH == "wasm" {
		data, err := base64.StdEncoding.DecodeString(wasmELFFixture)
		if err != nil {
			t.Fatalf("decode embedded ELF fixture: %v", err)
		}
