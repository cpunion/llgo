...
- Phase 36之后的主要缺口仍是工程闭环而非新的coroutine可行性障碍：零/单source
  `ResumePacket`及Channel/select typed multi-source materialization已经完成，下一步是HostOp deadline、
  keyed/transport composite cleanup、动态P/steal和blocking compensation；paged/dynamic channel、timer与
