...
| LockOSThread/entersyscall | Native exact G→M/P lock、同M foreign call及其managed-execution permit leave/reenter已通过generated-cgo/Python与单配额补偿E2E | locked-G异常退出的物理M退休、动态M/P、同P ready/source handoff和完整entersyscall/exitsyscall |
